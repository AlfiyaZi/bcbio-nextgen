...
def annotate_novel_coding(assembled_db, ref_db, ref_fasta, data, out_file=None):
    if not out_file:
...
def cleanup_transcripts(assembled_gtf, assembled_db, ref_db, ref_fasta, out_file=None):
    """
